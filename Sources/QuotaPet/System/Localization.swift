...
enum L10n {
    enum Key: String, CaseIterable {
        ...
        case settingsCodexTrustCurrent = "settings.codex_trust.current"
        case settingsCodexTrustAlternatives = "settings.codex_trust.alternatives"
        case settingsCodexTrustNoneTrusted = "settings.codex_trust.none_trusted"
        ...
        case settingsCodexBadgePrimary = "settings.codex_trust.badge.primary"
        case settingsCodexBadgeTrusted = "settings.codex_trust.badge.trusted"
        case settingsCodexBadgePending = "settings.codex_trust.badge.pending"
