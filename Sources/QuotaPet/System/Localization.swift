...
enum L10n {
    enum Key: String, CaseIterable {
        ...
        case settingsModePickHint = "settings.mode_pick_hint"
        case settingsHotkeys = "settings.hotkeys"
        case settingsHotkeysHelp = "settings.hotkeys.help"
        case settingsHotkeysTitle = "settings.hotkeys.title"
        case settingsHotkeysSubtitle = "settings.hotkeys.subtitle"
        case settingsShortcutChange = "settings.shortcut.change"
        case settingsShortcutRecording = "settings.shortcut.recording"
        case settingsShortcutInvalid = "settings.shortcut.invalid"
        case settingsResetShortcut = "settings.reset_shortcut"
        case hotkeyRestorePetTitle = "hotkey.restore_pet.title"
        case hotkeyRestorePetDetail = "hotkey.restore_pet.detail"
        ...
        case settingsCodexTrustHelp = "settings.codex_trust.help"
        case settingsCodexListeningChatGPT = "settings.codex_listening.chatgpt"
        case settingsCodexListeningTerminal = "settings.codex_listening.terminal"
        case settingsCodexListeningNone = "settings.codex_listening.none"
        case settingsCodexChannelChatGPTTitle = "settings.codex_channel.chatgpt.title"
        case settingsCodexChannelTerminalTitle = "settings.codex_channel.terminal.title"
        case settingsCodexChannelChatGPTMissing = "settings.codex_channel.chatgpt.missing"
        case settingsCodexChannelTerminalMissing = "settings.codex_channel.terminal.missing"
        case settingsCodexChannelTerminalTip = "settings.codex_channel.terminal.tip"
        case settingsCodexUseThis = "settings.codex_use_this"
        case settingsCodexRescan = "settings.codex_rescan"
        case settingsCodexPickFile = "settings.codex_pick_file"
        case settingsCodexStatusMissing = "settings.codex_status.missing"
        case settingsCodexStatusPending = "settings.codex_status.pending"
        case settingsCodexStatusReady = "settings.codex_status.ready"
        case settingsCodexStatusActive = "settings.codex_status.active"
        case settingsCodexScanOnlyChatGPT = "settings.codex_scan.only_chatgpt"
        case settingsCodexScanFoundTerminal = "settings.codex_scan.found_terminal"
        case settingsCodexScanFoundNone = "settings.codex_scan.found_none"
        case settingsCodexSourceChatGPT = "settings.codex_trust.source.chatgpt"
        case settingsCodexSourceCodexApp = "settings.codex_trust.source.codex_app"
        case settingsCodexSourceHomeChatGPT = "settings.codex_trust.source.home_chatgpt"
        case settingsCodexSourceHomeCodex = "settings.codex_trust.source.home_codex"
        case settingsCodexSourceHomebrew = "settings.codex_trust.source.homebrew"
        case settingsCodexSourceLocal = "settings.codex_trust.source.local"
        case settingsCodexSourcePath = "settings.codex_trust.source.path"
        case settingsCodexSourceUser = "settings.codex_trust.source.user"
        ...
        case settingsTrustIgnoredNoise = "settings.trust.ignored_noise"
        case settingsTrustShowNoise = "settings.trust.show_noise"
        case settingsTrustMore = "settings.trust.more"
        case settingsTrustAllTitle = "settings.trust.all_title"
        case settingsTrustClose = "settings.trust.close"
        case settingsTrustShowDetails = "settings.trust.show_details"
