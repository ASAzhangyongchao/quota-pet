...
设置、更新、排障与卸载请阅读[中文使用指南](docs/USER_GUIDE.zh-CN.md)。非隶属、商标、兼容性和原创素材来源见 [LEGAL.zh-CN.md](LEGAL.zh-CN.md)，参与贡献请遵循 [CONTRIBUTING.zh-CN.md](CONTRIBUTING.zh-CN.md)。
...
MIT，见 [LICENSE](LICENSE) 与独立的[法律与品牌说明](LEGAL.zh-CN.md)。
